...
# #(定长类型,(维度))
# g = np.array([(1, 2, 3, 4)], dtype=(np.int32, 4))  # 每个元素的类型是4个int32
# print('g', g.dtype, g.shape, g)
# g = np.array([((1, 2), (3, 4))], dtype=(np.int32, (2, 2)))
# print('g', g.dtype, g.shape, g)

# #'类型字符串1，类型字符串2，...'
# h = np.array([('1234', (1, 2, 3, 4))], dtype='U4,4i4')
# print('h', h.dtype, h[0]['f0'], h[0]['f1'], h)
...
# k = np.array([('1234', (1, 2, 3, 4))], dtype=[('fa', 'U4'), ('fb', '4i4')])
